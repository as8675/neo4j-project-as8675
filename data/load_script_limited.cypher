...
:auto LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/as8675/neo4j-project-as8675/main/data/healthcare_noshows.csv' AS line
WITH line LIMIT 20000
CALL {
    WITH line
